...
export default function BookingModal({ open, onClose, packageName }) {
  ...
  <div className="px-5 py-4 bg-gradient-to-r from-orange via-orange to-amber-500 text-white relative overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex-1">
              <h5 className="font-bold font-poppins text-lg md:text-xl mb-1">Plan Your Dream Holiday ✈️</h5>
              <p className="text-white/90 text-xs font-canva-sans">Fill in the details and we'll get back to you shortly</p>
            </div>
            <button 
              onClick={onClose} 
              className="text-white text-2xl leading-none hover:rotate-90 transition-transform duration-300 w-9 h-9 flex items-center justify-center rounded-full hover:bg-white/20"
  ...
  <div className="p-5 md:p-6">
          <form onSubmit={handleSubmit} className="space-y-4" id="bookingForm">
            ...
            <div className="bg-gradient-to-r from-orange/10 to-amber-50 rounded-xl p-3 border-l-4 border-orange">
            ...
            <div className="space-y-4">
              ...
              <div className="group">
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-300 rounded-xl px-3 py-2.5 focus:border-orange focus:outline-none focus:ring-2 focus:ring-orange/20 transition-all font-canva-sans group-hover:border-gray-400"
                />
              </div>
              ...
              <div className="group">
                ...
                <div className="flex items-stretch border-2 border-gray-300 rounded-xl overflow-hidden focus-within:border-orange focus-within:ring-2 focus-within:ring-orange/20 transition-all group-hover:border-gray-400">
                  <span className="px-3 py-2.5 bg-gray-100 border-r-2 border-gray-300 font-semibold text-darkBlue font-canva-sans flex items-center">
                    🇮🇳 +91
                  </span>
                  <input
                    required
                    ...
                    className="flex-1 px-3 py-2.5 outline-none font-canva-sans"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3">
                  ...
                  <div className="flex items-center justify-between border-2 border-blue-300 rounded-xl overflow-hidden bg-white">
                    <button 
                      type="button" 
                      className="px-3 py-2.5 hover:bg-blue-100 active:bg-blue-200 transition-colors font-bold text-base text-darkBlue disabled:opacity-50 disabled:cursor-not-allowed" 
                    ...
                    <button 
                      type="button" 
                      className="px-3 py-2.5 hover:bg-blue-100 active:bg-blue-200 transition-colors font-bold text-base text-darkBlue" 
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-3">
                  ...
                  <div className="flex items-center justify-between border-2 border-green-300 rounded-xl overflow-hidden bg-white">
                    <button 
                      type="button" 
                      className="px-3 py-2.5 hover:bg-green-100 active:bg-green-200 transition-colors font-bold text-base text-darkBlue disabled:opacity-50 disabled:cursor-not-allowed" 
                    ...
                    <button 
                      type="button" 
                      className="px-3 py-2.5 hover:bg-green-100 active:bg-green-200 transition-colors font-bold text-base text-darkBlue" 
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-3">
                  ...
                  <div className="flex items-center justify-between border-2 border-pink-300 rounded-xl overflow-hidden bg-white">
                    <button 
                      type="button" 
                      className="px-3 py-2.5 hover:bg-pink-100 active:bg-pink-200 transition-colors font-bold text-base text-darkBlue disabled:opacity-50 disabled:cursor-not-allowed" 
                    ...
                    <button 
                      type="button" 
                      className="px-3 py-2.5 hover:bg-pink-100 active:bg-pink-200 transition-colors font-bold text-base text-darkBlue" 
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-orange to-amber-500 text-white font-bold py-3 px-5 rounded-xl hover:shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 font-poppins text-base disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
